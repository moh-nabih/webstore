...
<div class="container mt-4 w-full">
    <div class="width-full flex justify-between items-center mb-4">
        <h1 class="text-2xl font-semibold mb-4 text-left">{{ $category->name }}</h1>
    </div>
    @if ($category->items->isEmpty())
        <div class="m-auto text-center">
            <p class="text-gray-700 text-sm mb-4">No items available in this category.</p>
        @else
        </div>
